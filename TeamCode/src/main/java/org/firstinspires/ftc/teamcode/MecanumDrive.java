...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 50.0 / 2187.67;
        public double lateralInPerTick = 50.0 / 2080.00;
        public double trackWidthTicks = 1122.5006046223905;

        // feedforward parameters (in tick units)
        public double kS = 0.9409386288016091;
        public double kV = 0.0044355873006771285;
    ...
    public TrajectoryActionBuilder reversedActionBuilder(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                TurnAction::new,
                FollowTrajectoryAction::new,
                beginPose, 1e-6, 0.0,
                ...
                new PoseMap() {
                    ...
                    public Pose2dDual<Arclength> map(@NonNull Pose2dDual<Arclength> pose2dDual) {
                        return Pose2dDual.constant(new Pose2d(pose.position.x, -pose.position.y, pose.heading.inverse().toDouble()), 1);
                    }
